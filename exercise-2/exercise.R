...
highest.raise.employee <- (salaries[salaries$raise == highest.raise])

# What was the largest decrease in salaries between the two years?
biggest.paycut <- min(salaries$raise)

# What was the name of the employee who recieved largest decrease in salary?
biggest.paycut.employee <- (salaries[salaries$raise == highest.raise])

# What was the average salary increase?
average.salary.change <- mean(salaries$raise)
...
avg.paycut <- mean(salaries$raise[salaries$got.raise == FALSE])
